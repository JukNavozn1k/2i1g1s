...
begin
        ...
        repeat
                ...
                i:=i+1;
                a := -10;
                while (a < -2.41936) or (a >= 10) do begin
                write('Введите первую точку (a >= -2.41936) и (a < 10): ');
                read(a);
                gotoxy(10,y+i);
                i:=i+1;
                end;
...
begin
        ...
        begin
                ...
                // График
                SetColor(12);
                x := -2.41936; y := 0; // Стартовые координаты
                step := x;
                while x < x0 do 
                begin
                      ...
                      PutPixel(x0-round(sx*(x/(dx))),round(y0+sy*((y-38)/(dy))),12); // График нечётной функции с переводом пикселей в координаты OX <= 0
                      end;
